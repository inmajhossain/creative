    ...
    <div className="top-0 z-99 sticky bg-cyan-950 mx-auto w-full">
      ...
      <div className="flex lg:flex-row flex-col justify-between items-center drop-shadow-2xl mx-auto px-[50px] py-[10px] lg:py-0 lg:h-[67px]">
        ...
        <div className="flex flex-row justify-between lg:justify-around items-center gap-[20px] px-[10px] w-[390px] lg:w-[240px]">
          ...
          <Link href="/contact">
            <button className="group relative lg:flex bg-black hover:shadow-[0_0_7px_4px_#61caff] active:shadow-[0_0_10px_5px_rgba(168,85,247,0.4)] mt-[10px] lg:mt-0 px-8 py-3 border-2 border-cyan-400 rounded-full font-semibold text-white active:scale-95 transition-all duration-800">
