  ...
  return (
    <div className="flex flex-col justify-between items-center mx-auto mt-[50px] w-full md:w-[768px] lg:max-w-[1280px]">
      ...
      <div className="flex flex-row justify-between items-start lg:gap-[175px]">
        ...
        {/* Right Side */}
        <div className="hidden md:hidden lg:hidden relative xl:flex border-amber-100 border-l-[5px] h-[4050px]">
          <motion.div
            animate={{ y: [200, 0] }}
          ...
          <motion.div
            animate={{ y: [200, 0] }}
            transition={{ duration: 3, delay: 1 }}
            className="top-[3550px] right-[-40] absolute flex justify-center items-center bg-slate-100 shadow-[0_0_7px_4px_#61caff] border-2 border-cyan-400 rounded-full w-[80px] h-[80px] overflow-hidden font-bold text-[30px] text-cyan-950 text-center hover:rotate-360 transition-all animate-pulse animate-rotate duration-1000"
          >
            6
          </motion.div>
        </div>
